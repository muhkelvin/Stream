    ...
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('admin.movies.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="synopsis" id="synopsis" rows="10" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter the full movie synopsis" required></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="url" name="movie_url" id="movie_url" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter movie URL (optional)">
            </div>
